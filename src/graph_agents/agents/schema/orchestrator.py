...
from graph_agents.agents.schema.to_model.er_diagram_to_model import ERDiagram2ModelAgent
from graph_agents.agents.schema.to_model.pg_diagram_to_model import PGDiagram2ModelAgent
...
class GraphSchemaAgent(LlmAgent):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            sub_agents=[
                NL2ModelAgent(model),
                ERDiagram2ModelAgent(model),
                PGDiagram2ModelAgent(model),
